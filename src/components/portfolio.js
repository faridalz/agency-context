...
export default function Portfolio() {
    ...
    return (
            ...
            <div className="tools4">
                <Link style={{marginLeft: "15%"}} to="/all">HAMISI</Link>
                <Link to="/business-solutions">BİZNES HƏLLƏRİ</Link>
                <Link to="/marketing">RƏQƏMSAL MARKETİNQ</Link>
                <Link to="/veb-projects">VEB LAYİHƏLƏR</Link>
                <Link to="/">QABLAŞDIRMA</Link>
                <Link to="/video">VİDEO</Link>
                <Link to="/design">DİZAYN</Link>
            </div>
